...
class _CreateSessionScreenState extends State<CreateSessionScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Criar Nova Sessão')),
          ...
          child: Column(
            ...
            children: [
              TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Nome do Bingo', border: OutlineInputBorder()),
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Prêmio', border: OutlineInputBorder()),
                validator: (value) => value!.isEmpty ? 'Campo obrigatório' : null,
              ),
